...
void main() {
  runApp(const CobbleApp());
}

class CobbleApp extends StatelessWidget {
  const CobbleApp({super.key});
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            const Text(
                              'Closest reliable global fallback: add Cobble to Quick Settings. The recording engine remains independent from gesture detection for future upgrades.',
                            ),
                          ],
                        ),
                      ),
...
class ScreenRecorderApi {
  ...
  static const MethodChannel _methodChannel =
      MethodChannel('com.graphicmiles.cobble/recorder');
  static const EventChannel _eventChannel =
      EventChannel('com.graphicmiles.cobble/events');
