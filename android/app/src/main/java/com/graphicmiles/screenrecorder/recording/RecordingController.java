...
public final class RecordingController {
    ...
    public static synchronized Map<String, Object> getStatus(Context context) {
        ...
        status.put(
                ...
                "Android does not expose invisible system-wide raw triple-tap detection to ordinary apps without overlays or elevated privileges. Screen Recorder uses a Quick Settings tile and the recording notification as the reliable global fallback."
        );
